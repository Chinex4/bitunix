...
function Me({ children: e8, enabled: t12 = true }) {
  ...
  let { refs: b11, floatingStyles: w10, context: g8 } = useFloating2({ open: i19, placement: a25 === "selection" ? p6 === "center" ? "bottom" : `bottom-${p6}` : p6 === "center" ? `${a25}` : `${a25}-${p6}`, strategy: "absolute", transform: false, middleware: [offset2({ mainAxis: a25 === "selection" ? 0 : E15, crossAxis: v5 }), shift2({ padding: c19 }), a25 !== "selection" && flip2({ padding: c19 }), a25 === "selection" && P7 ? inner({ ...P7, padding: c19, overflowRef: u19, offset: r21, minItemsVisible: q, referenceOverflowThreshold: c19, onFallbackChange(h11) {
    var O9, W3;
    if (!h11) return;
