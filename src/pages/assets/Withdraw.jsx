...
export default function Withdraw() {
	...
	const fetchCoins = async () => {
		...
		const cachedTime = localStorage.getItem('cached_withdraw_time');
		...
		try {
			...
			setCoins(all);
			localStorage.setItem('cached_withdraw_coins', JSON.stringify(all));
			localStorage.setItem('cached_withdraw_time', Date.now().toString());
		} catch (err) {
