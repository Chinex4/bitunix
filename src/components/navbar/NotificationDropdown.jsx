  ...
  return (
    <div className='relative' ref={dropdownRef}>
      ...
      {dropdowns.notifications && (
        <div className='absolute -right-20 md:right-0 mt-3 w-[350px] md:w-[500px] bg-[#121212] text-white rounded-lg border border-neutral/20 shadow-xl p-4 z-50 max-h-[400px] overflow-y-auto no-scrollbar'>
